...
const productos = [
  {
    ...
    img: img1,
    presentacion: "0,9 kg",
    descripcion: "Paté húmedo sabor salmón para gatos.",
    categoria: "Gato: Alimentos",
    stock: 10,
  },
  {
    id: "#999",
    nombre: "Ricocan en trozos",
    img: img2,
    presentacion: "14 kg",
    descripcion: "Croquetas nutritivas para perros adultos.",
    categoria: "Perro: Alimentos",
    stock: 29,
  },
  {
    id: "#0223",
    nombre: "Cama leeby estilo Puppy",
    img: img3,
    presentacion: "40cm x 60cm",
    descripcion: "Cama acolchada para perros pequeños.",
    categoria: "Perro: Camas",
    stock: 21,
  },
  {
    id: "#4344",
    nombre: "Cama leeby estilo cueva",
    img: img4,
    presentacion: "20cm x 30cm x 40cm",
    descripcion: "Cueva de felpa para gatos que aman esconderse.",
    categoria: "Gato: Camas",
    stock: 10,
  },
  {
    id: "#6425",
    nombre: "Collar vino deluxe",
    img: img5,
    presentacion: "1 unidad",
    descripcion: "Collar elegante con cierre de seguridad.",
    categoria: "Perro: Correas",
    stock: 33,
  },
  {
    id: "#5454",
    nombre: "Mini ratón tricot",
    img: img6,
    presentacion: "1 unidad",
    descripcion: "Juguete para gatos con textura suave.",
    categoria: "Gato: Juguetes",
    stock: 7,
  },
  {
    id: "#2344",
    nombre: "Arena para gatos TKPET",
    img: img7,
    presentacion: "11 kg",
    descripcion: "Arena absorbente para gatos con aroma natural.",
    categoria: "Gato: Higiene",
    stock: 14,
  },
];
          ...
          {productos.map((prod, index) => (
            <tr key={index}>
              ...
              <td className="acciones">
                ...
                <button className="btn-icono eliminar">🗑️</button>
              </td>
            </tr>
          ))}
        </tbody>
