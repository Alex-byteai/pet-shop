      ...
      <div className="users-section">
        <div className="users-registered">
          <div className="section-header">
            ...
            <button className="btn-orange">Ver todos los usuarios</button>
          </div>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              {usersData.map(([img, name, status], i) => (
                <tr key={i}>
                  ...
                  <td>
                    <button className={status === 'Activo' ? 'btn-red' : 'btn-green'}>
      ...
      <div className="orders-section">
        <div className="section-header">
          ...
          <div className="section-buttons">
            <button className="btn-orange">Ver productos</button>
            <button className="btn-orange">Ver todas las ordenes</button>
          </div>
        </div>
        <table>
          <thead>
